...
const QUICK_CALC_CARDS = [
  {
    ...
    imageSource: require('@/assets/images/welcome_bluu.png'),
    fields: [
  ...
  },
  {
    ...
    imageSource: require('@/assets/images/tags_bluu.png'),
    fields: [
  ...
  },
  {
    ...
    imageSource: require('@/assets/images/thumbs_bluu.png'),
    fields: [
  ...
  },
  {
    ...
    imageSource: require('@/assets/images/glass_bluu.png'),
    fields: [
      ...
      <ScrollView
        ...
        <View className="flex-row items-end justify-between gap-5">
          <View className="flex-1">
            <Text className="text-5xl font-extrabold text-primary-foreground">빠른 계산</Text>
            <Text className="mt-1 text-base font-semibold text-primary-foreground/80">
              자주 쓰는 계산을 바로 해결해요
            </Text>
          </View>
          <View className="h-14 w-14 items-center justify-center rounded-2xl bg-primary-foreground/20">
        ...
        <View className="flex-row items-center gap-3 rounded-full bg-primary-foreground/90 px-4 py-3">
